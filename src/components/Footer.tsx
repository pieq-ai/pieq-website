        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-20">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#" className="text-sm text-zinc-400 hover:text-[#A6823C] transition-colors">FLOW Intelligence Core</a></li>
              <li><a href="#" className="text-sm text-zinc-400 hover:text-[#A6823C] transition-colors">Agent Marketplace</a></li>
